...
class AlgorithmGA(GeneticAlgorithm):
    ...
    def _update_history(self):
        ...
        df.to_csv(r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\mainMethod\OptClust-H\metrics\metrics_STRING_humain.csv", index=False)

        save_complexes(best_solution, r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\mainMethod\OptClust-H\complexes\complexes_STRING_humain.txt")
        solution_id = 0
        complexe_id = 0
        ...
        population_pd.to_csv("/kaggle/working/population_STRING_humain.txt", index=False)
...
if __name__ == "__main__":
    ...
    ppi_path = r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\Data\clean data\weighted_networks\weighted_STRING_humain.txt"
    complexes_path = r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\Data\clean data\complexes\STRING_humain.txt"
    ...
    population = []
    complex_path = r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\initialization\complexes\detected_complexes_STRING_humain.txt"
    ...
    # Résultats
    save_complexes(best_solution.genes, r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\mainMethod\OptClust-H\complexes\STRING_humain.txt")
