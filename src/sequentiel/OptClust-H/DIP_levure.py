...
class AlgorithmGA(GeneticAlgorithm):
    ...
    def _update_history(self):
        ...
        df.to_csv(r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\mainMethod\OptClust-H\metrics\metrics_DIP_levure.csv", index=False)

        save_complexes(best_solution, r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\mainMethod\OptClust-H\complexes\complexes_DIP_levure.txt")
        solution_id = 0
        complexe_id = 0
        ...
        population_pd.to_csv("/kaggle/working/population_DIP_levure.txt", index=False)
...
if __name__ == "__main__":
    ...
    ppi_path = r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\Data\clean data\weighted_networks\weighted_DIP_levure.txt"
    complexes_path = r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\Data\clean data\complexes\DIP_levure.txt"
    ...
    population = []
    complex_path = r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\initialization\complexes\detected_complexes_DIP_levure.txt"
    ...
    # Résultats
    save_complexes(best_solution.genes, r"C:\Users\PC\Documents\M2 HPC\PFE\PFE_CODE\results\mainMethod\OptClust-H\complexes\DIP_levure.txt")
