...
def main():
    try:
        # Setup logging
        setup_logger("kefsi_mekhazni_workspace/results/DIP_levure/dip_levure.log",
                     "kefsi_mekhazni_workspace/results/DIP_levure/dip__levure.err")
        ...
        PPI_PATH = os.path.join(BASE_DIR, "data/ppi_networks/weighted_DIP_levure.txt")
        REF_PATH = os.path.join(BASE_DIR, "data/golden_complexes/DIP_levure.txt")
        INIT_PATH = os.path.join(BASE_DIR, "data/initialization_complexes/detected_complexes_DIP_levure.txt")
        RESULT_PATH = os.path.join(BASE_DIR, "results//DIP_levure/best_solution.txt")
