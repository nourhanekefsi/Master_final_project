...
def main():
    try:
        # Setup logging
        setup_logger("kefsi_mekhazni_workspace/results/BIOGRID_humain/biogrid_humain.log",
                     "kefsi_mekhazni_workspace/results/BIOGRID_humain/biogrid_humain.err")
        ...
        PPI_PATH = os.path.join(BASE_DIR, "data/ppi_networks/weighted_BIOGRID_humain.txt")
        REF_PATH = os.path.join(BASE_DIR, "data/golden_complexes/BIOGRID_humain.txt")
        INIT_PATH = os.path.join(BASE_DIR, "data/initialization_complexes/detected_complexes_BIOGRID_humain.txt")
        RESULT_PATH = os.path.join(BASE_DIR, "results//BIOGRID_humain/best_solution.txt")
