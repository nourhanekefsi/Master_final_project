...
def main():
    try:
        # Setup logging
        setup_logger("kefsi_mekhazni_workspace/results/biogrid_levure.log",
                     "kefsi_mekhazni_workspace/results/biogrid_levure.err")
        ...
        PPI_PATH = os.path.join(BASE_DIR, "data/ppi_networks/weighted_BIOGRID_levure.txt")
        REF_PATH = os.path.join(BASE_DIR, "data/golden_complexes/BIOGRID_levure.txt")
        INIT_PATH = os.path.join(BASE_DIR, "data/initialization_complexes/detected_complexes_BIOGRID_levure.txt")
        RESULT_PATH = os.path.join(BASE_DIR, "results/best_solution.txt")
        ...
        population2 = random_initialization(references, ppi, population_size=26,
                                            max_complexes=len(references)*10, max_size=40)
