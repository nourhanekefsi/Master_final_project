...
def main():
    try:
        # Setup logging
        setup_logger("kefsi_mekhazni_workspace/results/STRING_levure/string_levure.log",
                     "kefsi_mekhazni_workspace/results/STRING_levure/string_levure.err")
        ...
        PPI_PATH = os.path.join(BASE_DIR, "data/ppi_networks/weighted_STRING_levure.txt")
        REF_PATH = os.path.join(BASE_DIR, "data/golden_complexes/STRING_levure.txt")
        INIT_PATH = os.path.join(BASE_DIR, "data/initialization_complexes/detected_complexes_STRING_levure.txt")
        RESULT_PATH = os.path.join(BASE_DIR, "results//STRING_levure/best_solution.txt")
